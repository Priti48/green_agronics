...
const CERTIFICATIONS = ['FSSAI', 'GMP', 'ISO 22000', 'Halal', 'Organic'];

const SOCIAL = [
  {
    label: 'Instagram',
    href: 'https://www.instagram.com/greenagronics',
    icon: (
  ...
  {
    label: 'LinkedIn',
    href: 'https://www.linkedin.com/company/greenagronics',
    icon: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
        ...
        <div className={styles.container}>
          ...
          <div className={styles.brandCol}>
            ...
            <p className={styles.tagline}>
              Premium Makhana Exporter &amp; Organic Wellness Supplier from Bihar, India.
            </p>
            ...
            <div className={styles.contact}>
              ...
              <span className={styles.contactLink}>📍 {SITE.address}</span>
            </div>
          ...
          <div className={styles.certCol}>
            ...
            <div className={styles.exportCta}>
              <p>Ready to place a bulk order?</p>
              <a
                href={`https://wa.me/${SITE.whatsapp}?text=Hi%2C%20I%20want%20to%20place%20a%20bulk%20export%20order.`}
                target="_blank"
                rel="noopener noreferrer"
      ...
      <div className={styles.bottom}>
        <div className={styles.bottomInner}>
          <p className={styles.copyright}>
            © {year} Green Agronics Pvt. Ltd. All rights reserved.
          </p>
